<template>
  <div class="box" @click="clickMeow">
    ...
    >
      <path fill="#fafafa" d="M0 0h800v600H0z" />
      <path
        id="shadow"
      ...
      <path
        ...
        fill="#bddad8"
      />
      <path fill="#fafafa" d="M0 357.995h800V600H0z" />
      ...
      <g id="skateCat">
        ...
        <g id="fly">
          ...
          <path
            ...
            stroke-linecap="round"
          />
          <circle class="zzz" cx="336.557" cy="245.842" r="2.132" fill="#fff" />
          <path
            class="zzz"
            d="M333.148 242.371h6.881l-6.943 6.943h6.631"
            fill="none"
        ...
        <g id="tire-front">
          <g id="tire">
            <circle cx="516.487" cy="340.43" r="16.043" fill="#556f80" />
            <g fill="#bddad8">
              <path
        ...
        <g id="tire-back">
          <g id="tire1">
            <circle cx="390.724" cy="340.43" r="16.043" fill="#556f80" />
            <g fill="#bddad8">
              <path
        ...
        <g id="cat">
          ...
          <g id="face">
            ...
            <g clip-path="url(#_clip2)">
              <ellipse cx="411.177" cy="260.615" rx="6.738" ry="21.523" fill="#556f80" />
            </g>
            <path
...
export default {
  ...
  methods: {
    clickMeow: function() {
      this.smokeRotation = -this.smokeRotation;
      gsap.to("#smoke", {
        rotation: this.smokeRotation,
